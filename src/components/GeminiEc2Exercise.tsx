// src/components/GeminiEc2Exercise.tsx
"use client";
...
const GeminiEc2Exercise = () => {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    setFeedback(null);
    console.log(
      "Soumission de la réponse pour évaluation EC2 (Gemini):",
      studentAnswer
    );

    try {
      // Note: Nous allons créer cette route API à la prochaine étape
      const response = await fetch("/api/evaluate-ec2-gemini", {
        method: "POST",
  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-md mb-8 w-full max-w-4xl mx-auto">
      ...
      <div className="mt-8 pt-6 border-t border-gray-200">
        ...
        <div>
          <label
            htmlFor="studentAnswerEc2Gemini" // ID unique pour le textarea
            className="block text-sm font-medium text-gray-700 mb-1"
          >
            Votre réponse :
          </label>
          <textarea
            id="studentAnswerEc2Gemini"
...
export default GeminiEc2Exercise;