// src/components/exercices/Exercice5Content.tsx
"use client";

import React, { useState } from "react";
// Pas besoin de Link ici si la navigation est gérée par le parcours
...
export default function Exercice5Content() {
  ...
  return (
    <div>
      {" "}
      {/* Conteneur de l'exercice */}
      {/* En-tête de l'exercice spécifique */}
      <div className="mb-8">
        ...
        <div className="mt-4 text-xs text-gray-500 text-left">
          ...
          <p>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer" // Ajout pour la sécurité et bonnes pratiques
            >
              Insee
            </a>
      ...
      <div className="bg-white p-6 rounded-lg shadow-md">
        ...
        >
          ...
          <p>
            Rédiger une phrase présentant la signification précise de la donnée{" "}
