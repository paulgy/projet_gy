// src/app/api/evaluate-ec2-gemini/route.ts
...
const EvaluationOutputSchema = z.object({
  evaluation: z.object({
    ...
    accuracy_issues: z
      ...
      .nullable()
      .optional()
      .describe("Erreurs factuelles (ex: mauvaise donnée, mauvaise interprétation)."),
    language_issues: z
      .array(z.string())
      .nullable()
      .optional()
...
Voici la réponse de l'élève à évaluer : "${studentAnswer}"`;
  ...
  try {
    ...
    const validationGemini = EvaluationOutputSchema.safeParse(evaluationData);
